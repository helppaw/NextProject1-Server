...
import com.revature.daos.ResultsDao;
...
public class ResultsServlet extends HttpServlet {
	...
	private ResultsDao resultsDao = ResultsDao.currentImplementation;
	...
	protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		if (userIdStr != null) { // find by Author name
			...
			results = resultsDao.findByStudentId(userId);
		} else { // find all
			results = resultsDao.findAll();
		}
	...
	protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		ObjectMapper om = new ObjectMapper();
		Results r = (Results) om.readValue(req.getReader(), Results.class);
